...
#載入 Follow 事件
from linebot.models.events import (FollowEvent, UnfollowEvent, MessageEvent, TextMessage, PostbackEvent, PostbackEvent, ImageMessage, AudioMessage, VideoMessage)
...
# 建立 line event log, 用來記錄 line event
...
def handle_line_image(event):
    return LindBotController.handle_image_message(event)
